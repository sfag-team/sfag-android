...
import com.sfag.automata.model.simulation.Branch
...
class FiniteMachine(
     ...
     */
    private fun calculateAllPathsStep(): SimulationStep {
        ...
        if (allTransitions.isEmpty()) {
            ...
            return SimulationStep.Ended(if (anyAccepting) SimulationOutcome.ACCEPTED else SimulationOutcome.REJECTED)
        }
