...
import com.sfag.automata.TREE_NODE_HORIZONTAL_SPACING
import com.sfag.automata.TREE_NODE_VERTICAL_SPACING
import com.sfag.automata.TREE_PADDING
import com.sfag.automata.model.simulation.ExplorationTree
import com.sfag.automata.model.simulation.TreeNode

fun calculateLayout(tree: ExplorationTree): Map<Int, Offset> {
