package com.sfag.automata.ui.viewmodel
...
class AutomataViewModel @Inject internal constructor(private val storage: AutomataFileStorage) : ViewModel() {
    ...
    /** Sets the active machine and initialises layout state. */
    ...
    fun calculateNextStep(): SimulationResult =
        CurrentMachine.machine?.calculateNextStep() ?: SimulationResult.Ended(null)
