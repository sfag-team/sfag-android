...
import com.sfag.grammar.ui.viewmodel.GrammarViewModel
import com.sfag.grammar.ui.viewmodel.InputsViewModel
import com.sfag.grammar.ui.component.widget.FilePicker
import com.sfag.grammar.ui.component.widget.FileSave
import com.sfag.grammar.ui.navigation.GrammarDestinations
...
import com.sfag.shared.ui.icon.FileOpen
import com.sfag.shared.ui.icon.FileSave
    ...
    CenterAlignedTopAppBar(
        ...
        navigationIcon = {
            ...
            IconButton(
                ...
                Icon(FileSave, contentDescription = "Save Grammar to a file", tint = MaterialTheme.colorScheme.primary)
            }}
        },
        actions = {
